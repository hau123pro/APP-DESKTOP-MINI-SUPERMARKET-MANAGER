...
public class phieuNhapPanel {
    ...
    private JTextField txFindItem, txcreatedate, txbillid, txtimncc, txdiachincc, txsdtnhacungcap, txghichu, txTotal, txKhachTra, txTienDu;
    ...
    public void getPhieuNhapPanel(JPanel panel, JPanel pntitle, JLabel lbtitle, String us, String pw){
        ...
        buy.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                pndao.insertToDBPhieuNhap(txbillid.getText(), nvbll.getMaFromName(cbnhanvien.getSelectedItem().toString()), 
        ...
        txtimncc.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if(e.getKeyCode()==KeyEvent.VK_BACK_SPACE){
                    ...
                    txsdtnhacungcap.setText(nccbll.getSDTByName(name));
                    txdiachincc.setText(nccbll.getDiaChiByName(name));
