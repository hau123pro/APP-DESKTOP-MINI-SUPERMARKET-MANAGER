...
public class hoaDonPanel {
    ...
    private JTextField txFindItem, txcreatedate, txbillid, txtimkh, txdiachikh, txsdtkhachhang, txghichu, txTotal, txKhachTra, txTienDu;
        ...
        sell.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                hddao.insertToDBHoaDon(txbillid.getText(),                                                          //mã hóa đơn
                                       nvbll.getMaFromName(cbnhanvien.getSelectedItem().toString()),                //mã nhân viên
