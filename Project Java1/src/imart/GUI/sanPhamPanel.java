...
//        pntab11.add(pntheongay);
        ...
        pntab122121.remove(pnttnv[6]);
        txttnv[4].setEditable(true);
        pnttnv[6].remove(lbttnv[6]);
        pnttnv[6].remove(txttnv[6]);
        pnttnv[6]= new JPanel();
        pnttnv[6].setBackground(Color.white);
        pnttnv[6].setLayout(new GridLayout(1, 1, 20,0));
        pnttnv[6].setBorder(BorderFactory.createEmptyBorder(20,5,20,5));
        lbttnv[6]= new JLabel(thongtin[6]);
        lbttnv[6].setHorizontalAlignment(4);
        lbttnv[6].setFont(new Font("Tahoma", Font.PLAIN, 20));
        pnttnv[6].add(lbttnv[6]);
        pnttnv[6].add(cbmaloai);
        pntab122121.add(pnttnv[6]);
...
//                String newid= nvbll.getNhanVienList().get(nvbll.getNhanVienList().size()-1).getId();
//                StringBuilder sb= new StringBuilder(newid);
//                nvdao.insertToDBNhanVien("NV0"+String.valueOf(nvbll.getNhanVienList().size()), txttnv[1].getText(), txttnv[2].getText(), txttnv[3].getText(), txttnv[4].getText(),
//                                           txttnv[5].getText(),txttnv[6].getText(),nvbll.changeGenderToNum(txttnv[7].getText()),txttnv[8].getText() );
//                tkdao.insertToDBTaiKhoan("NV0"+String.valueOf(nvbll.getNhanVienList().size()-1).toLowerCase(), "1", "NV0"+String.valueOf(nvbll.getNhanVienList().size()-1));
//                addFullTable();
//                
//                pntab121.repaint();
//                pntab121.validate();
...
//            }
        ...
        lbsua.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                pntab121.removeAll();
                spdao.updateDBSanPham2(txttnv[0].getText(), Double.valueOf(txttnv[4].getText()));
                addFullTable();
                pntab121.repaint();
                pntab121.validate();
            }
        ...
        tb.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                for(int a=0;a<spbll.getHeader().length;a++){
                    txttnv[a].setText(spbll.getTable().getValueAt(i, a).toString());
                }
                for(int cv=0;cv<cbmaloai.getItemCount();cv++){
                    if(cbmaloai.getItemAt(cv).toString().trim().equals(lhbll.getNameByID(txttnv[6].getText()))){
