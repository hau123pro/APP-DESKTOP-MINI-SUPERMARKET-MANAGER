...
public class khachHangBLL{
    ...
    public String[] getTenKhachHang(){
        this.list.setKhachhang(getKhachHangList());
        String[] listtenkh= new String[list.getKhachhang().size()];
        for(int i=0;i<list.getKhachhang().size();i++){
            listtenkh[i]= list.getKhachhang().get(i).getHo()+" "+list.getKhachhang().get(i).getTen();
        }
        return listtenkh;
    }
